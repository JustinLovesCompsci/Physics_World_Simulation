...
public class PhysicalObjectRect extends PhysicalObject
{
    ...
    protected double[] myPolyx;
    protected double[] myPolyy;
    ...
    public void init (double width, double height, double mass)
    {
        ...
        shape.setAsBox((float) width/2, (float) height/2); //changed by nick from shape.setAsBox((float) width, (float) height);
        createBody(shape);
